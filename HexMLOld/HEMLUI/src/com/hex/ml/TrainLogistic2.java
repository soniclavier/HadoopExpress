...
public final class TrainLogistic2 {
  ...
  private static boolean parseArgs(String[] args) {
    ...
    TrainLogistic2.inputFile = getStringArgument(cmdLine, inputFile);
    TrainLogistic2.outputFile = getStringArgument(cmdLine, outputFile);
    ...
    TrainLogistic2.scores = getBooleanArgument(cmdLine, scores);
    TrainLogistic2.passes = getIntegerArgument(cmdLine, passes);
